...
[Trace palladium is everywhere](https://www.nature.com/articles/d41586-022-01612-3): catalytic converters across 1.4 billion cars have flecked Pd onto every surface on Earth, from Antarctica to bench glassware. The result is a long lineage of "metal-free catalysis" papers that turn out to be parts-per-billion of contaminating Pd doing all the work — an unintentional adversary, but an adversary all the same, that fakes the signal you're hunting for.

[Fast16](https://www.sentinelone.com/labs/fast16-mystery-shadowbrokers-reference-reveals-high-precision-software-sabotage-5-years-before-stuxnet/): state-sponsored malware that surgically patched floating-point operations inside precision simulation tools like LS-DYNA, subtly corrupting outputs from crash testing, structural analysis, and nuclear research. Not data theft, not denial-of-service — just quietly degraded numerical accuracy in pipelines where small errors compound into real-world consequences. The corrupted signal looks completely valid; you only catch it if you know to compare against an uninfected machine.

[Disappearing polymorphs](https://en.wikipedia.org/wiki/Disappearing_polymorph): a crystal form that grew reliably for years can become unmakeable once a more stable polymorph nucleates somewhere on Earth — seed crystals as small as 10⁻¹⁵ grams (a few million molecules) drift through lab air, manufacturing facilities, and shipping containers, converting any attempt at the old form into the new one. Ritonavir's original Form I vanished this way in 1998: Form II appeared in Abbott's plants, kept reseeding them, and forced a $250M reformulation because the original form could no longer be reliably produced anywhere they manufactured.
